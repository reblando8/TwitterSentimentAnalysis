...
# Scraping twitter api for sentimental analysis
# When there is a dollar sign in a tweet then we keep the tweet.
...
while (searchMethod == "1" or searchMethod == "2"):
    ...
    if searchMethod == "1":
        ...
        user = input("User: ")
        limit = 30
        tweets = tweepy.Cursor(api.user_timeline, screen_name = user, count = 400, tweet_mode = 'extended').items(limit)
